from .utils import create_callback_token_for_user, send_email_with_callback_token, custom_send_sms_with_callback_token
...
class TokenService(object):
    ...
    def send_token(user, alias_type, **message_payload):
        ...
        print('drfpasswordless/services.py: token generated {}'.format(token))
        send_action = None
        if alias_type == 'email':
