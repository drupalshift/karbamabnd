...
# r = requests.post('http://localhost:8000/auth/mobile/', data={'mobile':'09302862537'})
# r = requests.post('http://localhost:8000/callback/auth/', data={'token':'929063'})


# TODO replace print with proper error log