# Generated by Django 2.0.2 on 2018-05-03 21:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('service_delivery', '0013_auto_20180503_2026'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='delivery_time',
            field=django_jalali.db.models.jDateTimeField(blank=True, null=True, verbose_name='زمان تحویل'),
        ),
        migrations.AlterField(
            model_name='medicalsession',
            name='date',
            field=django_jalali.db.models.jDateTimeField(blank=True, null=True, verbose_name='تاریخ جلسه'),
        ),
        migrations.AlterField(
