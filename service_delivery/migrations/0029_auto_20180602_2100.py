# Generated by Django 2.0.2 on 2018-06-02 21:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('service_delivery', '0028_auto_20180602_2041'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='client',
            field=models.ForeignKey(default=service_delivery.models.service_default_user, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, verbose_name='مشتری'),
        ),
        migrations.AlterField(
            model_name='baseservice',
            name='personnel',
            field=models.ForeignKey(default=service_delivery.models.service_default_user, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='personnel', to='service_delivery.Personnel', verbose_name='پرسنل'),
        ),
        migrations.AlterField(
            model_name='baseservice',
            name='schedule_time',
            field=django_jalali.db.models.jDateTimeField(default=service_delivery.models.default_datetime, verbose_name='زمان ارائه خدمت'),
        ),
        migrations.AlterField(
