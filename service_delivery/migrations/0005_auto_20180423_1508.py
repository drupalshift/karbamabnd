...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('service_delivery', '0004_auto_20180423_1505'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='user',
            name='invite_id',
            field=django_smalluuid.models.SmallUUIDField(blank=True, default=django_smalluuid.models.UUIDDefault(), null=True, unique=True, verbose_name='شناسه یکتا'),
        ),
